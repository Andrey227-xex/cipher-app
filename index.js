...
import { uploadingFile } from "./working-with-files/download.js"; // импортируем функцию загрузить файл 
import { writingToFile } from "./working-with-files/write.js"; // импортируем функцию сохранить в файл
...
const loadFileInput = document.getElementById("loadFileInput"); // скрытый input type="file" в HTML
const loadFileButton = document.getElementById("loadFileButton"); // кнопка загрузить
...
const btnSaveToFile = document.getElementById("btnSaveToFile"); // кнопка сохранить в файл
...
// добавляем обработчик для input type="file" выбор файла
loadFileInput.addEventListener("change", uploadingFile);


// добавляем обработчик кнопке загрузить
loadFileButton.addEventListener("click", () => {
    loadFileInput.click(); // программный клик
})
